...
<div class="container">
    ...
    <form method="GET" action="{{ route('admin.accounts.index') }}" class="mb-4">
        <div class="row">
            <div class="col-md-4">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-2">
                                <a href="{{ route('admin.accounts.edit', $account->id) }}" class="btn btn-warning btn-sm">Sửa</a>
                                <form action="{{ route('admin.accounts.destroy', $account->id) }}" method="POST" onsubmit="return confirm('Bạn có chắc muốn thay đổi trạng thái tài khoản này?');">
                                    @csrf
                                    @method('DELETE')
                                    @if($account->status == 1)
